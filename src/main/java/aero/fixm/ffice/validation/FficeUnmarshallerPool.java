...
public class FficeUnmarshallerPool {
    ...
    public FficeUnmarshallerPool() {
        try {
            ...
            throw new IllegalStateException("Failed to initialize FficeUnmarshallerPool", e);
        }
    }

    public Object unmarshalAndValidate(String xml) throws FficeUnmarshalException {
        if (xml == null || xml.isBlank()) {
            throw new FficeUnmarshalException("XML content is null or empty");
        }
        ...
        try {
            ...
            throw new FficeUnmarshalException("XML validation failed: " + extractMessage(e), e);
        } catch (JAXBException | SAXException | ParserConfigurationException e) {
            throw new FficeUnmarshalException("XML unmarshalling failed: " + extractMessage(e), e);
        } finally {
            pool.offer(u);
        }
    }
    ...
    private Schema loadSchema() throws SAXException {
        ...
        if (rootUrl == null) {
            throw new IllegalStateException("FF-ICE root XSD not found on classpath: " + ROOT_XSD);
        }
        try (InputStream is = rootUrl.openStream()) {
            return factory.newSchema(new StreamSource(is, rootUrl.toString()));
        } catch (java.io.IOException e) {
            throw new IllegalStateException("Failed to read FF-ICE root XSD: " + ROOT_XSD, e);
        }
    }
    ...
    public static class FficeUnmarshalException extends Exception {
        public FficeUnmarshalException(String message) {
            super(message);
        }

        public FficeUnmarshalException(String message, Throwable cause) {
            super(message, cause);
        }
    }
    ...
    private static class ClasspathResourceResolver implements LSResourceResolver {
        ...
        public LSInput resolveResource(String type, String namespaceURI, String publicId, String systemId, String baseURI) {
            ...
            URL resourceUrl = FficeUnmarshallerPool.class.getClassLoader().getResource(classpathPath);
            if (resourceUrl == null) {
                return null;
            }
