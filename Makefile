...
help:
	@echo ""
	@echo "  fixm-ffice-model — available targets"
	@echo "  ─────────────────────────────────────────────────────────"
	@echo ""
...
deps:
	...
	@echo ""
	@echo "    git clone https://github.com/swim-developer/swim-developer"
	@echo "    cd swim-developer && ./mvnw install -N -DskipTests"
	@echo ""
...
sonar:
	./mvnw clean verify sonar:sonar \
		...
		-Dsonar.projectKey=fixm-ffice-model \
		-Dsonar.projectName=fixm-ffice-model
